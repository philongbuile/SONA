...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ] ; then
	CC_SRC_PATH="../sample/chaincode/fabcar/go/"
elif [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
	CC_SRC_PATH="../sample/chaincode/fabcar/javascript/"
elif [ "$CC_SRC_LANGUAGE" = "java" ]; then
	CC_SRC_PATH="../sample/chaincode/fabcar/java"
elif [ "$CC_SRC_LANGUAGE" = "typescript" ]; then
	CC_SRC_PATH="../chaincode-typescript/"
<<<<<<< HEAD:sona/startFabric.sh
=======
elif [ "$CC_SRC_LANGUAGE" = "sona" ]; then
	CC_SRC_PATH="../chaincode-typescript/"  
>>>>>>> main:fabcar/startFabric.sh
else
...
./network.sh deployCC -ccn sona  -ccv 1 -cci InitLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
