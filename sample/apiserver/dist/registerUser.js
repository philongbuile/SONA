...
async function main() {
  try {
    ...
    if (userIdentity) {
      console.log(
        'An identity for the user "userOne" already exists in the wallet'
      );
      return;
    }
    ...
    console.log(
      'Successfully registered and enrolled admin user "philongUser1" and imported it into the wallet'
    );
  } catch (error) {
