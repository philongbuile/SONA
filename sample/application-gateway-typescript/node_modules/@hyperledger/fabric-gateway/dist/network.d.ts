...
export declare class NetworkImpl implements Network {
    ...
    getName(): string;
    getContract(chaincodeName: string, contractName?: string): Contract;
    getChaincodeEvents(chaincodeName: string, options?: Readonly<ChaincodeEventsOptions>): Promise<CloseableAsyncIterable<ChaincodeEvent>>;
    newChaincodeEventsRequest(chaincodeName: string, options?: Readonly<ChaincodeEventsOptions>): ChaincodeEventsRequest;
    getBlockEvents(options?: Readonly<BlockEventsOptions>): Promise<CloseableAsyncIterable<common.Block>>;
    newBlockEventsRequest(options?: Readonly<BlockEventsOptions>): BlockEventsRequest;
    getFilteredBlockEvents(options?: Readonly<BlockEventsOptions>): Promise<CloseableAsyncIterable<peer.FilteredBlock>>;
    newFilteredBlockEventsRequest(options?: Readonly<BlockEventsOptions>): FilteredBlockEventsRequest;
    getBlockAndPrivateDataEvents(options?: Readonly<BlockEventsOptions>): Promise<CloseableAsyncIterable<peer.BlockAndPrivateData>>;
