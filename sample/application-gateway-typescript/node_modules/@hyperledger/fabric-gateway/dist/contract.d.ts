...
import { ProposalOptions } from './proposalbuilder';
...
export declare class ContractImpl implements Contract {
    #private;
    ...
    evaluate(transactionName: string, options?: ProposalOptions): Promise<Uint8Array>;
    submit(transactionName: string, options?: ProposalOptions): Promise<Uint8Array>;
    submitAsync(transactionName: string, options?: Readonly<ProposalOptions>): Promise<SubmittedTransaction>;
