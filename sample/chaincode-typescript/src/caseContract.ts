...
export class CaseContract extends Contract {
    ...
    // @Transaction()
    // public async CreateCase(ctx: Context, patient_id: string, testresult: string,diagnosis: string,treatment: string): Promise<Case> {
    ...
    //     };
    //     ctx.stub.putState(id, Buffer.from(stringify(sortKeysRecursive(new_case))));
    //     return new_case;
    // }
